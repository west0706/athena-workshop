...
aws emr create-cluster --name emr-$student \
    ...
    --ec2-attributes '{"KeyName":"$student-key","InstanceProfile":"EMR_EC2_DefaultRole","SubnetId":"subnet-10477259","EmrManagedSlaveSecurityGroup":"sg-1ffc5363","EmrManagedMasterSecurityGroup":"sg-23fc535f"}' \
    --service-role EMR_DefaultRole --enable-debugging --release-label emr-5.3.0 --region us-east-1 \
